...
- (void)initValues
{
    ...
    _selectedMenuItemLabelColor   = [UIColor colorWithRed:1.000 green:0.443 blue:0.000 alpha:1.00];
    _unselectedMenuItemLabelColor = [UIColor blackColor];
...
- (void)configureUserInterface
{
    ...
    if (_useMenuLikeSegmentedControl) {
        ...
        if (_centerMenuItems) {
            selectionIndicatorFrame = CGRectMake(0.0, _menuHeight - _selectionIndicatorHeight, _menuItemWidth, _selectionIndicatorHeight);
        } else {
