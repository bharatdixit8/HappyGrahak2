//
//  MostPopularProductTableViewCell.swift
//  HappyGrahak
//
...
class MostPopularProductTableViewCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    @objc func getMostPopularProduct(){
        ...
        let urlString = BASE_URL + "most-popolar-product?" + params
        print(urlString)
